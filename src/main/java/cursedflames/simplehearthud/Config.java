 ...
 * 
 * Copied into SHH from CursedLib because I'm too lazy to re-figure out how to
 * do configs without this
 * 
 * @author CursedFlames
 *
 */
...
//	Map<String, Property> serverProps = new HashMap<>();
	...
	private Map<String, Property> getLocalPropMap(EnumPropSide side) {
